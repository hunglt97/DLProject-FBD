...
if __name__ == '__main__':
    ...
    # fbdnet.demo('abg2.jpg', filepath)
    # # fbdnet.demo('phuc0.jpg', filepath)
    # fbdnet.demo('edward.jpg', filepath)
    # fbdnet.demo('edward0.jpg', filepath)
    # fbdnet.demo('tuyen.png', filepath)
    # fbdnet.demo('trump1.jpg', filepath)
    # fbdnet.demo('nghia1.jpg', filepath)
    # fbdnet.demo('trump10.jpg', filepath)
    fbdnet.demo('1a0.jpg', filepath)
    fbdnet.demo('1a1.jpg', filepath)
    fbdnet.demo('1a2.jpg', filepath)
    fbdnet.demo('1a3.jpg', filepath)
    fbdnet.demo('1a4.jpg', filepath)
    # fbdnet.demo('tuyen.png', filepath)
